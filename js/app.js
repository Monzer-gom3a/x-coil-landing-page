...
const translations = {
    ...
    ar: {
        ...
        bearings_title: "قاعدة بيانات المحامل",
        bearings_subtitle: "ابحث في آلاف المحامل حسب الرقم أو الأبعاد",
        filter_bearing_number: "رقم المحمل",
        ...
        results_placeholder: "أدخل معايير البحث أعلاه للعثور على المحامل",
        results_found: "تم العثور على {count} محمل",
        results_showing: "عرض {start}-{end} من {total}",
        table_bearing_number: "رقم المحمل",
        table_inner: "القطر الداخلي",
        table_outer: "القطر الخارجي",
        table_thick: "السماكة",
        table_type: "النوع",
        no_results: "لم يتم العثور على محامل مطابقة لمعاييرك",
        loading: "جارٍ تحميل بيانات المحامل...",
